...
function ItemRow({ item, value, onChange, iconSrc }: ItemRowProps) {
  ...
  return (
    <div className="flex flex-col sm:grid sm:grid-cols-[1fr_auto_auto] sm:items-center border-b border-gray-200 last:border-0">
      <div className="py-2 px-3 sm:py-3 sm:pr-4 sm:pl-0 sm:border-r sm:border-gray-200"><span className="text-sm font-medium text-foreground">{item}</span></div>
      <div className="py-2 px-3 sm:py-3 sm:px-4 bg-gray-50 sm:border-r sm:border-gray-200 flex justify-center sm:w-[150px]"><Image src={iconSrc} alt={item} width={150} height={150} className="object-contain h-20 w-auto sm:h-[150px] sm:w-[150px]" /></div>
    ...
    <form onSubmit={handleSubmit} className="mx-auto max-w-3xl space-y-6 p-4 pb-12 lg:p-8 lg:pb-16">
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>Document Ref: HSEMS/8.1.19/REG/010 | Rev. 2 | 20.04.2024</CardDescription>
        </CardHeader>
      </Card>
      ...
      <div className="grid grid-cols-4 gap-2 text-xs text-muted-foreground border-t pt-4">
        <div><span className="font-semibold">Document Reference No.</span><br />HSEMS / 8.1.19 / REG / 010</div>
        <div><span className="font-semibold">Author</span><br />HSE Manager</div>
        <div><span className="font-semibold">Revision</span><br />2</div>
        <div><span className="font-semibold">Creation Date</span><br />20.04.2024</div>
      </div>
